...
const Projects = () => {
  return (
    <div className="mt-5 mb-30 relative">
      ...
      <Link
        className="flex gap-2 items-center mx-auto text-lg border w-fit dark:border-white/60  px-4 py-1 border-dashed mt-10  border-black/40  transition-all duration-300 dark:bg-neutral-900 bg-neutral-100 hover:dark:bg-neutral-950 hover:bg-neutral-200 "
        href="/projects"
      >
        {" "}
